...
export default function DpaPage() {
  return (
    <main className="legalPage">
      ...
      <p>Käsittelyn jälkeen Mac-sovellus käyttää tunnistettuja tietoja Fennoan kenttien täyttämiseen paikallisen selainautomaation avulla. Käyttömäärän laskentaa varten backend-palveluun lähetetään onnistuneen Fennoa-tallennuksen jälkeen vain minimimäärä käyttötietoa.</p>
